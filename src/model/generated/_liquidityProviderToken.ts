...
export class LiquidityProviderToken {
  public readonly isTypeOf = 'LiquidityProviderToken'
  private _id!: string
  ...
  constructor(props?: Partial<Omit<LiquidityProviderToken, 'toJSON'>>, json?: any) {
